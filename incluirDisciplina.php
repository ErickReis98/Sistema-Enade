...
<html>
	...
	<body>
		<div class='divSup'>
			...
			<div class='textSup'><h1>Cadastro da disciplina</h1></div>
		...
		<div class='container'>
			...
			<div class='divSub'>
				...
				<?php 
					...
					$sql = 
					"insert into tbDisciplina (nomeDisciplina) values ('$nomeDisciplina')";
	...
	?>
			...
			<div class='opcoesResult'>
				A disciplina foi cadastrada com sucesso. O que deseja fazer?
			</div>
